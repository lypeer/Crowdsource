...
public class MyPublishAdapter extends RecyclerView.Adapter<MyPublishAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
         ...
         * 报名人数的textview
         */
        private TextView tvApplicantNum;
        ...
        public MyViewHolder(View itemView) {
            ...
            tvSchool = (TextView) itemView.findViewById(R.id.my_publish_tv_school);
            tvStatus = (TextView) itemView.findViewById(R.id.my_publish_tv_status);
            tvDetail = (TextView) itemView.findViewById(R.id.my_publish_tv_detail);
