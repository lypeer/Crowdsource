 ...
 */
public class AcceptedBillAdapter extends RecyclerView.Adapter<AcceptedBillAdapter.MyViewHolder> {
     ...
     */
    public AcceptedBillAdapter(Context context, List<Bill> billsList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MyViewHolder(LayoutInflater.from(context).inflate(R.layout.item_accepted_bill, parent, false));
    }
...
//        holder.tvLeftTimeSecond.setText(timeList.get(2));
            ...
            holder.tvDetail.setText(R.string.system_detail0);
...
//        private TextView tvLeftTimeSecond;
        ...
        public MyViewHolder(View itemView) {
            ...
            cvBill = (CardView) itemView.findViewById(R.id.accepted_bill_cv_bill);
            sdvHeadPortrait = (SimpleDraweeView) itemView.
                    findViewById(R.id.accepted_bill_sdv_head_portrait);
            tvName = (TextView) itemView.findViewById(R.id.accepted_bill_tv_name);
            tvSchool = (TextView) itemView.findViewById(R.id.accepted_bill_tv_school);
            tvStatus = (TextView) itemView.findViewById(R.id.accepted_bill_tv_status);
            tvDetail = (TextView) itemView.findViewById(R.id.accepted_bill_tv_detail);
            tvAward = (TextView) itemView.findViewById(R.id.accepted_bill_tv_award);
            tvLeftTimeHour = (TextView) itemView.findViewById(R.id.accepted_bill_tv_left_time_hour);
            tvLeftTimeMinutes = (TextView) itemView.findViewById(R.id.accepted_bill_tv_left_time_minutes);
            ivBillType = (ImageView)itemView.findViewById(R.id.accepted_bill_iv_bill_type);
//            tvLeftTimeSecond = (TextView) itemView.findViewById(R.id.accepted_bill_tv_left_time_second);
        }
    }
