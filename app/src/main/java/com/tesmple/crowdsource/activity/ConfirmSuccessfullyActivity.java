...
/**
 * Created by lypeer on 10/25/2015.
 */
public class ConfirmSuccessfullyActivity extends AppCompatActivity {
    /**
...
//        goBack();
    ...
    private void initToolbar() {
        ...
        toolbar.setTitle(R.string.prompt_confirm_successflly);
    ...
    private void initView() {
        tvHour = (TextView) findViewById(R.id.confirm_successfully_tv_hour);
        tvMinute = (TextView) findViewById(R.id.confirm_successfully_tv_minute);
        tvSecond = (TextView) findViewById(R.id.confirm_successfully_tv_second);
    }
    ...
    private void goBack() {
        ...
        TimerTask timerTask = new TimerTask() {
            @Override
            public void run() {
                Intent intent = new Intent(ConfirmSuccessfullyActivity.this, MainActivity.class);
