 ...
 */
public class RobBillSuccessfullyActivity extends AppCompatActivity {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rob_bill_successfully);
        ActivityCollector.addActivity(RobBillSuccessfullyActivity.this);
        getBundleInfo();
        initView();
        initToolbar();
        //setDeadline();
...
//        goBack();
    ...
    private void initView() {
        tvHour = (TextView) findViewById(R.id.rob_bill_successfully_tv_hour);
        tvMinute = (TextView) findViewById(R.id.rob_bill_successfully_tv_minute);
        tvSecond = (TextView) findViewById(R.id.rob_bill_successfully_tv_second);

        findViewById(R.id.rob_bill_btn_to_by_bill).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//                startActivity(intent);
    ...
    private void goBack() {
        ...
        TimerTask timerTask = new TimerTask() {
            @Override
            public void run() {
                Intent intent = new Intent(RobBillSuccessfullyActivity.this, MainActivity.class);
                startActivity(intent);
                finish();
            }
        };
